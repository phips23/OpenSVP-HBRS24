    ...
    def __init__(self, params=None):
        ...
        if self.sc_capture == 'No':
            ...
            self.opal_map_phase_jump = OrderedDict({  # data point : analog channel name
                ...
                'AC_PF_1': self.model_name + '/SM_Source/IEEE_1547_TESTING/SignalConditionning/AC_PF_3/port1',
                ...
                'DC_I': None,
                'DC_P': None,
                'TRIG': self.model_name + '/SM_Source/IEEE_1547_TESTING/PCRT/Switch5/port1',
                'TRIG_GRID': self.model_name + '/SM_Source/IEEE_1547_TESTING/PCRT/Switch5/port1'})
